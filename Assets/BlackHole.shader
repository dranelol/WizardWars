    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                float2 node_897 = i.uv0;
                float4 node_669 = tex2D(_node_669,TRANSFORM_TEX(node_897.rg, _node_669));
                float node_15 = (distance(i.uv0.rg,float2(0.5,0.5))*2.0);
                float node_455 = (node_15*1.0);
                float node_457 = (1.0 - node_455);
