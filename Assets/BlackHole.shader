...
/////// Diffuse:
                ...
                float2 node_630 = i.uv0;
                float4 node_580 = tex2D(_node_580,TRANSFORM_TEX(node_630.rg, _node_580));
...
/////// Diffuse:
                ...
                float3 finalColor = 0;
                float3 diffuseLight = diffuse;
                float2 node_631 = i.uv0;
                float4 node_580 = tex2D(_node_580,TRANSFORM_TEX(node_631.rg, _node_580));
                finalColor += diffuseLight * node_580.rgb;
/// Final Color:
